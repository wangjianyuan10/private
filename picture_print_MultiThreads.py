...
def read_0(filepath):
    ...
    for i in range(len(size_list)):
        ...
        coordinate_dic.setdefault(i,None)
    ...
    return (size_dic,length_0,coordinate_dic)
def dic_To_List(coordinate_dic):
    length_1=[]
    for i in coordinate_dic.values():
        try:
            length_1.append(i[1])
        except:
            pass
    length_2=set(length_1)
    return sorted(list(length_2))
def picture_print(size_dic,length_0,coordinate_dic):
    iMage_0=ImageSeries(length_0)
    a=iMage_0.Image_series
    i=0
    j=0
    length_1=dic_To_List(coordinate_dic)
